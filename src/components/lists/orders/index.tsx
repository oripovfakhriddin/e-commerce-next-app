                ...
                <TableBody>
                  {row.cart.map((historyRow, i) => (
                    <TableRow key={historyRow?._id}>
                      ...
                      <TableCell align="center">
                        {typeof historyRow?.product?.category !== "string" ? (
                          historyRow?.product?.category?.name ? (
                            historyRow?.product?.category?.name
                          ) : (
                            <p className="bekor__qilingan">
                              Ma'lumot topilmadi!
                            </p>
                          )
                        ) : (
                      ...
                      <TableCell align="center">
                        {historyRow?.product?.description ? (
                          historyRow?.product?.description
                        ) : (
                          <p className="bekor__qilingan">Ma'lumot topilmadi!</p>
                        )}
                      ...
                      <TableCell align="center">
                        {historyRow?.quantity && historyRow?.product?.price ? (
                          historyRow?.quantity * historyRow?.product?.price
                        ) : (
                          <p className="bekor__qilingan">Ma'lumot topilmadi!</p>
                        )}
          ...
          <Table aria-label="collapsible table">
            <TableHead>
              <TableRow hover>
                ...
                <TableCell style={{ minWidth: "150px" }} align="right">
                  Mahsulot soni
                </TableCell>
              </TableRow>
            </TableHead>
