              ...
              { categoryData?.map((category) => {
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={category?._id}>
                    <TableCell align="center"><div className="category__image__box">
                      <Image src={category?.image?.url} alt={category?.image?.url} fill/>
                      </div></TableCell>
                    <TableCell align="center">{category?.name}</TableCell>
                    
                    <TableCell align="center">{trueDate(category?.createdAt)}</TableCell>
